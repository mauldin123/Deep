...
export default class Cavern5 extends Phaser.Scene {
  ...
  create(data) {
    ...
    this.add.image(130, 500, 'vent').setScale(0.3).setAngle(90);
    ...
    // Eels that dart back and forth
    var e1 = this.physics.add.sprite(249, 100, "eel")
      .setScale(0.15)
      .setAngle(45);
    ...
    var e2 = this.physics.add.sprite(249, 900, "eel")
      .setScale(0.15);
